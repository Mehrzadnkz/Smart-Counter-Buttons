        ...
        <div className="fixed inset-0 z-[70] bg-black/70 backdrop-blur-md" onClick={() => setSearchOpen(false)}>
          <div className="sticky top-0 px-4 pt-6" onClick={(e) => e.stopPropagation()}>
            <div className="max-w-xl mx-auto">
              <input type="text" autoFocus placeholder="Search dashboards..." className="w-full bg-gray-950 text-gray-100 rounded-lg px-4 py-3 border border-white/10 focus:ring-2 focus:ring-blue-500" />
            </div>
          </div>
        </div>
      )}
